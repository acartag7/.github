...
Copyright 2026 Edictum Contributors
...
1. for your internal use and internal business purposes;

2. for non-commercial or personal use;

3. to run the Software to govern, monitor, or manage AI agent tool calls
   within your own applications and infrastructure;

4. to modify the Software and use the modified version for any Permitted
   Purpose.
...
PARTICULAR PURPOSE, MERCHANTABILITY, TITLE OR NON-INFRINGEMENT. IN NO EVENT
WILL WE HAVE ANY LIABILITY TO YOU ARISING OUT OF OR RELATED TO THE SOFTWARE,
INCLUDING INDIRECT, SPECIAL, INCIDENTAL OR CONSEQUENTIAL DAMAGES, EVEN IF WE
HAVE BEEN INFORMED OF THEIR POSSIBILITY IN ADVANCE.
